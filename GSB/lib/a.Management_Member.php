...
if($_POST["button"] == "ค้นหา"){
	if(get_type($_POST["search"]) == "member"){
                $member_no = strip_tags($_POST["search"]);
                $member_no = str_replace("{","", $member_no); $member_no = str_replace("}","", $member_no); $member_no = str_replace(";","", $member_no); $member_no = str_replace("[","", $member_no); $member_no = str_replace("]","", $member_no); $member_no = str_replace("(","", $member_no); 
    ...
    <td width="17%" align="right">รหัสพนักงาน :</td>
    <td width="35%" align="left"><?=$salary_id?></td>
  </tr>
  <tr>
    <td align="right">ชื่อ - สกุล :</td>
    <td align="left"><?=$full_name?></td>
    <td align="right">ประเภทสมาชิก :</td>
    <td align="left"><?=$member_type?></td>
  </tr>
  <tr>
