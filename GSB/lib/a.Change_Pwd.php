...
<form id="formID1" name="formID1" method="post" action="">
  <table width="427" border="0" align="center" cellpadding="6" cellspacing="2">
    <tr>
      <td colspan="2" align="center"><strong><font size="2" face="Tahoma, Geneva, sans-serif">กำหนดรหัสผู้ใช้ใหม่อย่างน้อย 8 ตัวอักษร แต่ไม่เกิน 13 ตัวอักษร</font></strong></td>
    </tr>
    <tr>
...
if($_POST["ChkPwd"] != null){
	...
	if($chkpassword == $oldPassword){
		if($npwd == $oldPassword){
			...
			/*$table="staff_info";
			$value="staff_pwd = '".$npwd."'"; // ปรับ sql injection
