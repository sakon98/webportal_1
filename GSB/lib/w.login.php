   ...
   // require "../include/conf.c.php";
	...
	if(get_type_($getUsr) == "member"){
		...
		if(get_single_value_sql($chk,"chkmember") != 0 or get_single_value_oci($chk,"CHKMEMBER") != 0){		
					...
					$chk1 = "select count(member_no) as chkmember from mbmembmaster where member_no='$getUsr' and who_approve is not null ";
						if(get_single_value_sql($chk1,"chkmember") != 0){	
							...
							?>  <ul data-role="listview" data-ajax="false" data-inset="false" data-theme="c">
									<li><a href="../w/info.php?menu=SigeOut" data-rel="dialog" >ท่านยังไม่ได้ยืนยันเอกลักษณ์บุคคล กรุณาติดต่อสหกรณ์เพื่อยืนยันการสมัคร</a>
								</ul>
							<?php
							//exit;
						}
			...
			echo "<script>window.location = 'index.php'</script>";
							?>  <ul data-role="listview" data-ajax="false" data-inset="false" data-theme="c">
									<li><a href="../w/info.php?menu=SigeOut" data-rel="dialog" >กรุณาตรวจสอบทะเบียนสมาชิกหรือรหัสผ่านไม่ถูกต้อง<?=get_single_value_oci($chk,"CHKMEMBER")?></a>
								</ul>
							<?php
			//exit; 		
		}
		...
		if(get_single_value_sql($chk,"chkstaff") != 0){	
			...
			echo "<script>window.location = 'index.php'</script>";
							?>  <ul data-role="listview" data-ajax="false" data-inset="false" data-theme="c">
									<li><a href="../w/info.php?menu=SigeOut" data-rel="dialog" >กรุณาตรวจสอบทะเบียนสมาชิกหรือรหัสผ่านไม่ถูกต้อง</a>
								</ul>
							<?php
			//exit;	
		}
			...
			if($status){
				...
				*/
				...
				<div data-role="popup" id="popupNested" data-theme="none">
				   <ul data-role="listview" data-ajax="false" data-inset="false" data-theme="c">
						<li><a href="../w/info.php?menu=Member_info" data-transition="flip">ข้อมูลสมาชิก</a></li>
						<li><a href="../w/info.php?menu=Member_info" data-transition="flip">ข้อมูลส่วนตัว</a></li>
						<li><a href="../w/info.php?menu=Share" data-transition="flip">ข้อมูลหุ้น</a></li>
						<li><a href="../w/info.php?menu=Deposit" data-transition="flip">ข้อมูลเงินฝาก</a></li>
						<li><a href="../w/info.php?menu=Loan" data-transition="flip">ข้อมูลเงินกู้</a></li>
						<li><a href="../w/info.php?menu=Ref_collno" data-transition="flip">ข้อมูลค้ำประกัน</a></li>
						<li><a href="../w/info.php?menu=Payment" data-transition="flip">รายการหักประจำเดือน</a></li>
						<li><a href="../w/info.php?menu=SigeOut" data-rel="dialog" >ออกจากระบบ</a>
					</ul>
				</div>
				</div>
				-->
				...
				echo "<script>window.location = 'index.php'</script>";
							?>  <ul data-role="listview" data-ajax="false" data-inset="false" data-theme="c">
									<li><a href="../w/info.php?menu=SigeOut" data-rel="dialog" >เกิดข้อผิดพลาด !!! กรุณาเข้าใหม่อีกครั้ง</a>
								</ul>
							<?php
			}			
		}else if(get_type_($getUsr) == "staff"){
