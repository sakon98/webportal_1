...
<table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="140" height="100" align="right"><img src="../img/logo.png" width="115" height="110"></td>
      ...
      <tr>
		...
		<!--<br><br><br><br><img src="../img/confirm.png" border="0"><br><br><br><br><br><br>-->
		    ...
		    <tr>
		    <td><font color="#FFFFFF">แสดงรหัสผ่าน : </font></td>
                        <td>
                            <input type="checkbox" onclick="myFunction()"> <font color="#FFFFFF"></font>
                        </td>
                    </tr>
                    <tr>
                         <td></td>
                    ...
                    <tr>
                      ...
                      <td><span class="class1">
                        <?php if($connection == 0){ ?>
                        <font face='Tahoma' size="3"><a href="register.php">สมัครใช้บริการครั้งแรก</a></font>
	          &nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr>
                      ...
                      <td><span class="class1">
                        <?php if($connection == 0){ ?>
                        <font face='Tahoma' size="3"><a href="description.html">คู่มือใบเสร็จออนไลน์</a></font>
	          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                <font face='Tahoma' size="3"><a href="browser.html">เเนะนำ Browser</a></font>
                        <?php } ?>
                      </span></td>
                    </tr>
                  </table>
