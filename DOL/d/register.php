            ...
            <form name="formID1" id="formID1" method="post" action="" >
              <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  ...
                  <td width="61%"><input name="member_no" type="text" class="validate[required]" id="member_no" size="20" maxlength="10" autocomplete="off" /> <font color="#FF0000"> **กรอกเลขทะเบียนสมาชิก 8 หลัก</font> </td>
                </tr>
                <tr>
                  <td align="right"><font face="Tahoma" size="2"><strong><strong>เลขที่บัตรประชาชน :</strong></strong></font></td>
                  <td><input name="idchk" type="text" class="validate[required,custom[integer],minSize[13]]" id="idchk" size="20" maxlength="13" autocomplete="off"/> <font color="#FF0000"> **กรอกเลขบัตรประชาชน 13 หลัก</font> </td>
                </tr>
                <tr>
                  ...
                  <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
					...
					<tr>
					  <td height="30" colspan="2" align="left"><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
                          <td><strong><font size="2" face="Tahoma" color="red">ประกอบด้วยอักขระดังต่อไปนี้อย่างน้อย 2 ใน 3</font></strong></td>
                        </tr>
						<tr>
...
alert('รหัสประชาชนไม่ถูกต้อง');
  ...
  if (localStorage.clickcount) { // เข้า if นี้
      

      localStorage.clickcount = Number(localStorage.clickcount)+1; // ท่อนนี้น่าจะ + ได้ NAN เพราะลองฝั่งค่า 1 ไป get 1 ไป alert ได้
