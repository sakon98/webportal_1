        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="6">
          <tr>
			...
			<?php
				...
				}else if($_REQUEST["menu"] == "LoanRequest_Report"){
					require "../lib/a.loanrequest_report.php";
				}else if($_REQUEST["menu"] == "ConfirmReport" and $connection != 0){
					require "../d/confirmframe.html";
				}else if($_REQUEST["menu"] == "Acess"){
					require "acess_report.php";
				}else if($_REQUEST["menu"] == "Change_Pwd"){
					require "../lib/a.Change_Pwd.php";
				}else if($_REQUEST["menu"] == "Config"){
					require "../lib/a.Config.php";
