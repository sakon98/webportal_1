...
<?php
 $strSQL = "SELECT 
					TO_CHAR(SHS.SLIP_DATE, 'DD/MM/YYYY','NLS_CALENDAR=''THAI BUDDHA')AS SLIP_DATE,
					TO_CHAR(SHS.OPERATE_DATE, 'DD/MM/YYYY','NLS_CALENDAR=''THAI BUDDHA')AS OPERATE_DATE,
					...
					(SHS.SHARESTK_AMT*10) AS SHARESTK_AMT,(SHS.SHARESTK_AMT*10) AS SHARESTK_AMT2
				FROM 
				...
				WHERE 
					...
					ORDER BY SHS.SEQ_NO ";
$value=array('SLIP_DATE','OPERATE_DATE','SHRITEMTYPE_CODE','SHRITEMTYPE_DESC','SHARE_AMOUNT','SHARESTK_AMT','SHARESTK_AMT2');
