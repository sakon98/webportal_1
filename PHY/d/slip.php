      ...
      <tr>
        <td valign="top">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <?php for($i=0;$i<$Num_Rows;$i++){?>  
                <tr>
				  ...
				  ?> </td>
                  <td width="7%" align="center"><?=($period[$i] == 0) ? '' : $period[$i];?></td>
                  <td width="10%" align="right"><?=($slip_itemtype[$i] == 'LON') ? number_format($slip_principal[$i],2) : '';?></td>
                  <td width="10%" align="right"><?=($slip_itemtype[$i] == 'LON') ? number_format($slip_interest[$i],2) : '';?></td>
                  <td width="13%" align="right"><?=number_format($slip_pay[$i],2)?></td>
                  <td width="20%" align="right"><?=($itembalance[$i] == 0) ? '' : number_format($itembalance[$i],0);?></td>
                </tr>
                <?php } ?>
                <tr>
            ...
            <tr>
              <td align="center"><hr size="1" color="#CCCCCC">&nbsp;<br>ออกโดยระบบอัตโนมัติไม่จำเป็นต้องมีลายเซ็น</td>
            </tr>
          </table>        </td>
        </tr>
    </table></td>
