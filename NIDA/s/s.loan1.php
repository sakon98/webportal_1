...
$showslip = Show_Slip(date('d-m-Y'));
 ...
 $strSQL = "SELECT 
					...
					(((LNM.LOANAPPROVE_AMT-LNM.PRINCIPAL_BALANCE)*100)/LNM.LOANAPPROVE_AMT) AS PAY_PERSENT,LNM.LAST_PERIODPAY
				FROM 
...
$value=array('LOANTYPE_DESC','LOANCONTRACT_NO','LOANAPPROVE_AMT','STARTCONT_DATE','PERIOD_PAYAMT','PRINCIPAL_PAYMENT','INTEREST_PAYMENT','TOTALPAY','PRINCIPAL_BALANCE','PAY_PERSENT','LAST_PERIODPAY');
