...
<table width="85%" border="0" align="center" cellpadding="1" cellspacing="6">
  <tr>
    <td width="32%" height="35" align="center" bgcolor="#CCCCFF">หุ้นสะสม <font color="#FF6600"><strong><?= number_format($SHARE_AMT / 10,2) ?></strong></font> บาท</td>
    <td width="40%" align="center" bgcolor="#CCCCFF">มูลค่าหุ้นสะสม <font color="#FF6600"><strong><?= number_format($SHARE_AMT,2) ?></strong></font> บาท</td>
