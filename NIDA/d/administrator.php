...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        <td height="110" colspan="2" background="../img/head_info_bg01.png"><table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="140" height="105" align="right"><img src="../img/logo.png" width="101" height="101"></td>
      ...
      <tr>
        <td height="80" colspan="2" align="center" background="../img/footer_info_bg_test.png"><font size="2" color="#"><strong><?=$title?></strong></font><br/><font size="2" color="#"><?=$address?><br/><span class="class1"><?=$credite?></span></font></td>
      </tr>
    </table></td>
  </tr>
</table>
