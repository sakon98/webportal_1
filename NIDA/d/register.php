...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        <td height="120"  background="../img/head_info_bg_test.png"><table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <form name="formID1" id="formID1" method="post" action="" >
              <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  ...
                  <td width="61%"><input name="member_no" type="text" class="validate[required]" id="member_no" size="20" maxlength="10" autocomplete="off" /> </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                      ...
                      <input name="mobile1" type="hidden" class="validate[required,minSize[10]]" id="mobile1" size="35" value="<?=$mobile?>" autocomplete="off"/>
					  <?php }else { ?> 
                      <input name="mobile1" type="hidden" class="validate[minSize[10]]" id="mobile1" size="35" value="<?=$mobile?>" autocomplete="off"/>
                      <?php } ?></td>
                    </tr>
                    <tr>
					...
					<tr>
					  <td height="30" colspan="2" align="left"><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
                          <td><strong><font size="2" face="Tahoma" color="red">ประกอบด้วยอักขระดังต่อไปนี้</font></strong></td>
                        </tr>
						<tr>
                          <td><strong><font size="2" face="Tahoma" color="red">- ตัวเลข (0-9)</font></strong></td>
                        </tr>
						<tr>
                          <td><strong><font size="2" face="Tahoma" color="red">- ตัวอักษร (a-z, A-Z)</font></strong></td>
                        </tr>
						<tr>
                          <td><strong><font size="2" face="Tahoma" color="red">- อักขระพิเศษ (!@#$%^&*()_+|~-=\`{}[]:";'<>?,./)</font></strong></td>
                        </tr>
                      </table></td>
					</tr>
                    <tr>
...
<?php 
	...
	//echo 'เข้า valid_digit'; echo '</br>';	
	
	 $check_digit = 1; //echo '</br>';
	
	}if ($valid_c == 1 || $valid_C == 1){
	
	//echo 'เข้า valid_c'; echo '</br>';	
	
	 $check_c = 1; //echo '</br>';
	
	}if ($valid_Sp == 1){
	
	//echo 'เข้า valid_Sp'; echo '</br>';	
	...
	if($valid==false){
            echo '<script type="text/javascript"> window.alert("กำหนดรหัสผ่านไม่ได้ กรุณาลองใหม่") </script> ';
...
?>     
      ...
      <tr>
        <td height="120" align="center" background="../img/footer_info_bg_test.png"><span class="class1"><font size="2" color="#FFFFFF"><strong><?=$title?></strong></font><br/><font size="2" color="#FFFFFF"><?=$address?><br/><?=$credite?></font></span></td>
      </tr>
    </table></td>
  </tr>
</table>
