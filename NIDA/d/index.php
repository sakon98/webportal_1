...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#fff">
      <tr>
        <td height="120" background="../img/head_info_bg_test.png">
<table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="140" height="100" align="right"><img src="../img/logo.png" width="138" height="138"></td>
            <td width="845"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><font face='Tahoma' size="5" color="#"><strong>
                  <?=$title?>
                </strong></font><br/>
      ...
      <tr>
		...
		<img src="../img/left.jpg" border="0" style="width:63%;">
		</td>
                ...
                <td align="left" bgcolor="<?=$bg_login_color?>"><form name="formID1" method="post" action="">
                  <table width="400" border="0" align="center" cellpadding="0" cellspacing="8">
                    <tr>
                      ...
                      <td><input name="usr" type="text"class="inputs" id="usr" placeholder="ทะเบียนสมาชิก" autocomplete="off" required></td>
                    </tr>
                    <tr>
                        <td><font color="#FFFFFF">รหัสผ่าน : </font></td>
                      <td><input name="pwd" type="password"class="inputs" id="pwd" placeholder="รหัสผ่านประกอบด้วย (0-9,a-z,A-Z,!@#$...)"  autocomplete="off" required></td>
                    </tr>
                    <tr>
                         <td></td>
	       ...
	       <!-- <font face='Tahoma' size="3"><a href="description.html">แนะนำการใช้งาน</a></font>-->
              ...
              <tr>
				<td>
					<img src="../img/botton.jpg" border="0" style="width:100%;">
				</td>
      ...
      <tr>
        <td height="120" align="center" background="../img/footer_info_bg_test.png"><span class="class1"><font size="2" color="#"><strong><?=$title?></strong></font><br/><font size="2" color="#"><?=$address?><br/><?=$credite?></font></span></td>
      </tr>
    </table>     </td>
  </tr>
</table>
