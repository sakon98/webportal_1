  ...
  <table width="95%" border="0" align="center" cellpadding="3" cellspacing="6">
    <tr>
      <td align="center"><strong><font size="2" face="Tahoma">ค้นหาสมาชิก 
        ...
        <input name="search" type="text" id="search" size="35" maxlength="8" oninput="this.value=this.value.replace(/[^0-9]/g,'');" />
			...
			/*	$repwd = md5("1234");
                ...
                if(!$update_status){ */ ?>                
                 ...
                 <?php /*}else { 
                     ...
                     ?>
                 	<br/>ระบบได้เปลี่ยนรหัสสมาชิกให้เป็น <font size="4" color="#FF0000">"12345678"</font> แล้วกรุณาเข้าด้วยรหัสผ่านดังกล่าว<p>  
                 <?php //} ?>         
                </div>
            </div>
...
if($_POST["actions"] == "ลบ"){
	...
	if($status){
		...
		if($status){
                   ...
                   $strSQL_delete = "DELETE FROM weblog_action WHERE user = '".$_POST["member"]."' ";
