...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
 <form name="form_update" action="" method="post" onclick="return confirm('ท่านต้องการปรับปรุงข้อมูล Email ใช่ หรือ ไม่ !!!')">
  <tr>
  ...
  <tr>
   ...
   <tr>
	...
	<?php 
                ...
                $strSQL1 = " SELECT email FROM webmbmembmaster where member_no = '$member_no' ";
		$value1 = array('email');
		list($Num_Rows1,$list_info1) = get_value_many_sql($strSQL1,$value1);
		$email_web = $list_info1[0][0];

                ?>
    <td align="left"><input type="text" name="email" value="<?=$email_web?>" /></td>
  </tr>
  <tr>
      <td></td>
      <td></td>
...
<tr>
  ...
  <tr>
      <td></td>
      <td><input type="submit" name="update" id="update" value="ปรับปรุง" class="button1" onclick="return confirm('ท่านต้องการปรับปรุงข้อมูล Email ใช่ หรือ ไม่ !!!')"></td>
      <td></td>
      <td></td>
...
if ($conn->connect_error) {
 ...
 $sql = "UPDATE webmbmembmaster SET email = '$email_update' WHERE member_no = '$member_no'";
