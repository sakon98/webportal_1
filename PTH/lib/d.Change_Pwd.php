...
<form id="formID1" name="formID1" method="post" action="">
  <table width="400" border="0" align="center" cellpadding="6" cellspacing="2">
    <tr>
      <td colspan="2" align="center"><strong><font size="2" face="Tahoma" color="#FF0000">กำหนดรหัสผู้ใช้ 8 หลัก (ตัวเลข 0-9 หรือตัวอักษร a-z , A-Z)</font></strong></td>
    </tr>
	<tr>
    ...
    <tr>
      ...
      <td width="280" align="left"><input name="npwd" type="password" class="validate[required,minSize[8]]" id="npwd" size="25" maxlength="8" autocomplete="off" /></td>
    </tr>
	<tr>
      <td width="140" align="right"></td>
      <td width="280" align="left"></td>
    ...
    <tr>
      ...
      <td align="left"><input name="npwd1" type="password" class="validate[required,equals[npwd]]" id="npwd1" size="25" maxlength="8" autocomplete="off" /></td>
    </tr>
  </table>
  <hr align="center" size="1"  color="#999999" style="width:95%"/>
  <table width="400" border="0" align="center" cellpadding="6" cellspacing="2">
    <tr>
      <td align="center"><strong><font size="2" face="Tahoma" color="#FF0000">ยืนยันรหัสเดิมเพื่อยืนยันการเปลี่ยนรหัสผ่าน</font></strong></td>
    </tr>
	<tr>
      <td align="center">
      </td>
    ...
    <tr>
      ...
      <input name="oldpwd" type="password" class="validate[required]" id="oldpwd" size="25" maxlength="8" autocomplete="off"></td>
    </tr>
    <tr>
...
if($_POST["ChkPwd"] != null){
	...
	$date_log1 = strtotime("+6 hour", strtotime($date_log));
	$date_log1 = date('Y-m-d H:i:s', $date_log1); 
	...
	if($chkpassword == $oldPassword){
		if($npwd == $oldPassword){
			echo '<script type="text/javascript"> window.alert("ไม่สามารถเปลี่ยนรหัสผ่านใหม่ได้ กรุณาเปลี่ยนรหัสผ่านใหม่ให้ต่างจากเดิม") </script> ';
			echo "<script>window.location = 'info.php?menu=Change_Pwd'</script>";
			$ChkPwd = null;
			exit;
		}else{
			$table="webmbmembmaster";
			$value="password = '".$npwd."' ,  pwd = '".$_POST["npwd"]."' ,chang_flag = 0";
			...
			if(update_value_sql($table,$condition,$value)){
				...
				$value  = "('".$action_page."','".$member_no."','".$ipconnect."',(select now()),'".$connectby."')";
