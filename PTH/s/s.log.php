...
<?php
//echo $member_no;
$strMySQL = "SELECT 	id,date_log,action_do,ipconnect,connectby FROM weblog_action where user = '$member_no' order by id desc LIMIT 0 , 10";
...
?>
<table width="700" border="0" cellspacing="0" cellpadding="0" style="width: 359px;">
  <tr>
    <td bgcolor="#999999"><table width="700" border="0" cellpadding="3" cellspacing="1" style="width: 359px;">
      <tr>
 ...
 <?php   for($sq = 0 ; $sq < $rowSQL ; $sq++){    ?>
      <tr>
        <td height="25" align="center" bgcolor="#FFFFFF"><?=DateThai($log_date_log[$sq])?></td>
