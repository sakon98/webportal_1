...
<head>
    ...
    <link rel="stylesheet" href="http://fonts.googleapis.cหom/css?family=Open+Sans:300,400,700">
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        ...
        <table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="140" height="105" align="right"><img src="../img/logo.png" width="120" height="100"></td>
          ...
          <tr>
			...
			<?php
			 ...
			 $servername = "localhost";
                        ...
                        $sql = "SELECT chang_flag FROM webmbmembmaster where member_no = '$_SESSION[ses_member_no]'";
                        $result = $conn->query($sql);

                        while($row = $result->fetch_assoc()) {
                           $chang_flag = $row["chang_flag"];
						   }
			
			
			
				if($_REQUEST["menu"] == "" && $chang_flag <> 1){
					 require "../lib/d.news.php";
				}else if($_REQUEST["menu"] == "" and $connection != 1 && $chang_flag == 1){
