<?php
	...
	require "../include/conf.c_admin.php";
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        <td height="110" colspan="2" background="../img/head_info_bg1.png"><table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="109" height="105" align="right"><img src="../img/logo.png" width="101" height="101"></td>
      ...
      <tr bgcolor="<?=$menu_color?>">
        <td height="20" colspan="2" valign="top" bgcolor="<?=$undertop?>">&nbsp;</td>
        </tr>
      <tr>
          ...
          <tr>
			...
			<?php
				if($_REQUEST["menu"] == ""){
					...
					}else{ echo "<script>window.location = 'administrator.php?menu=News_editer'</script>"; }
				...
				}else if($_REQUEST["menu"] == "Update_Password" and $connection != 1){
				...
				else if($_REQUEST["menu"] == "Member_Detail"){
					echo "<a target=\"_blank\" href=\"../lib/a.Member_Detail.php\">แสดงรายงาน</a>";
				}else if($_REQUEST["menu"] == "Freez_Login"){
					require "../lib/a.freez_login.php";
				}
