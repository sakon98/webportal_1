         ...
         <!-- <ol class="carousel-indicators">
          ...
          <div class="carousel-inner">
            ...
            <div class="item active"> <img class="img-responsive" src="img/img1.jpg" alt="thumb">
              <div class="carousel-caption">ยินดีต้อนรับเข้าสู่ระบบบริการสมาชิก สหกรณ์ออมทรัพย์ครูเพชรบูรณ์ จำกัด</div>
            </div>
           <!-- <div class="item active"> <img class="img-responsive" src="img/1920x500.gif" alt="thumb">
      ...
      <div class="well">
        ...
        <form class="form-horizontal" >
          <div class="form-group">
            <label for="username" class="control-label">เลขทะเบียนสมาชิก</label>
            <div class="input-group">
            <div class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></div>
              <input type="text" class="form-control" name="usr" id="usr" required placeholder="กรอกเลขทะเบียนสมาชิก">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
            <div class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></div>
              <input type="text" class="form-control" name="pwd" id="pwd" required placeholder="กรอกรหัสผ่าน">
            </div>
          </div>
          <p class="text-center">
          <input type="submit" name="Submit" class="btn btn-primary" role="button" value="เข้าสู่ระบบ">
		  
			<a href="register.php" class="btn btn-success" role="button">สมัครใช้บริการ</a><b>
			<a href="description.html">แนะนำการใช้งาน</a>
