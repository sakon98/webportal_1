...
if($connection == 0){
$admin_menu  = array('ข้อมูลสรุปรวม','เพิ่มข่าวประกาศ','อนุมัติ-ลบ สมาชิก','รายชื่อสมาชิกทั้งหมด','ล๊อคเข้าสู่ระบบ','เปลี่ยนรหัสผ่าน');
$admin_link  = array('','News_editer','Management_Member','Member_Detail','Freez_Login','Change_Pwd');
}else{
