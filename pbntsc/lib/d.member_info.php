...
<table width="85%" border="0" align="center" cellpadding="1" cellspacing="6">
  <tr>
    ...
    <td width="17%" align="right">วันเกิด :<!--ประเภทสมาชิก :--></td>
    <td width="35%" align="left"><?=ConvertDate($birthday,"short")?> (<?=count_member($birthday,'ym')?>)<!--<?=$member_type?>--></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right"><!--ันที่เป็นสมาชิก :--></td>
