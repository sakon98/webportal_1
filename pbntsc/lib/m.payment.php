...
<?php for($i=0;$i<count($slip);$i++) { ?>
    <li><a href="info.php?menu=Payment_Show&slip_date=<?=$slip[$i] ?>"><font size="3"><?=$slip_s[$i] ?></font><span class="ui-li-count"><font size="1"><?=number_format($slipsum[$i],2)  ?></font></span></a></li>
<?php } ?>
</ul>