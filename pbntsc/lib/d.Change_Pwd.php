...
<form id="formID1" name="formID1" method="post" action="">
  <table width="400" border="0" align="center" cellpadding="6" cellspacing="2">
    <tr>
      <td colspan="2" align="center"><strong><font size="2" face="Tahoma" color="#FF0000">กำหนดรหัสผู้ใช้ใหม่อย่างน้อย 8 ตัวอักษร แต่ไม่เกิน 16 ตัวอักษร</font></strong></td>
    </tr>
    <tr>
      <td width="140" align="right">รหัสใหม่ :</td>
      <td width="280" align="left"><input name="npwd" type="password" class="validate[required,minSize[8]]" id="npwd" size="25" maxlength="16" autocomplete="off" /></td>
    </tr>
    <tr>
      <td align="right">ยืนยันรหัสใหม่ :</td>
      <td align="left"><input name="npwd1" type="password" class="validate[required,equals[npwd]]" id="npwd1" size="25" maxlength="16" autocomplete="off" /></td>
    </tr>
  </table>
  <hr align="center" size="1"  color="#999999" style="width:95%"/>
  <table width="400" border="0" align="center" cellpadding="6" cellspacing="2">
    <tr>
      <td align="center"><strong><font size="2" face="Tahoma" color="#FF0000">ยึนยันรหัสเดิมเพื่อยืนยันการเปลี่ยนรหัสผ่าน</font></strong></td>
    </tr>
    <tr>
      <td align="center"><label for="textfield"></label>
      <input name="oldpwd" type="password" class="validate[required]" id="oldpwd" size="25" maxlength="16" autocomplete="off"></td>
    </tr>
    <tr>
...
if($_POST["ChkPwd"] != null){
	...
	if($chkpassword == $oldPassword){
		if($npwd == $oldPassword){
			...
			$tableclare="memberclare";
			$valueclare="member_password = '".$npwdclare."'";
			$conditionclare="where member_no = '$member_no'";
			update_value_sql_2($tableclare,$conditionclare,$valueclare);
			
			if(update_value_sql($table,$condition,$value) && update_value_sql_2($tableclare,$conditionclare,$valueclare)){
