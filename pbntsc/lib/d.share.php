...
<table width="85%" border="0" align="center" cellpadding="1" cellspacing="6">
  <tr>
	...
	<td width="40%" align="center" bgcolor="#CCCCFF">ส่งหุ้นงวดละ <font color="#FF6600"><strong> (*งดส่งหุ้น*)</td>
	<?php }else{ ?>
	...
	<?php } ?>
    <td width="28%" align="center" bgcolor="#FFF"><!--งวดปัจจุบัน <font color="#FF6600"><strong><?= $LAST_PERIOD ?></strong></font>--></td>
  </tr>
</table>
<br />
<?php
  ...
  <tr>
    <td bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        ...
        <td width="13%" align="center" bgcolor="#CCCCFF"><strong>ถอน</strong></td>
