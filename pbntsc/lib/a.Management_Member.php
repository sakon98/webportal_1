		...
		<?php if($confirm2use == 1){	 ?>
		  ...
		  <tr>
           ...
           <form id="form2" name="form2" method="post" action="../lib/Update.php">
				<input type="submit" name="actions" id="actions" value="เปลี่ยนรหัสเป็นค่าเริ่มต้น">
				<input name="member" type="hidden" value="<?=$member_no?>" />
				 </form>    <a class="popup-alink-1"><b>ดูประวัติการเข้าใช้ 10 ครั้งล่าสุด</b></a>
			    
           	 	<?php //if($repassword == 1){ ?>
            	<!-- <a class="popup-alink-2" onclick="return confirm('ท่านต้องการเปลี่ยนรหัสผ่าน เป็น '1234' ใช่ หรือ ไม่ !!!')"><b>เปลี่ยนรหัสเป็นค่าเริ่มต้น</b></a> -->
            	<?php  //} ?>
            <?php  //} ?>
