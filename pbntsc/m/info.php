    ...
    <div data-role="popup" id="popupNested" data-theme="none">
       <ul data-role="listview" data-ajax="false" data-inset="false" data-theme="c">
            ...
            <li><a href="../m/info.php?menu=Loan" data-transition="flip">ข้อมูลเงินกู้</a></li>
			 <li><a href="../m/info.php?menu=LoanPermission" data-transition="flip">สิทธิ์กู้</a></li>
            <li><a href="../m/info.php?menu=Ref_collno" data-transition="flip">ข้อมูลค้ำประกัน</a></li>
			<li><a href="../m/info.php?menu=Payment" data-transition="flip">รายการหักประจำเดือน</a></li>
            <li><a href="../m/info.php?menu=Dividend" data-transition="flip">ปันผล-เฉลี่ยคืน</a></li>
            <li><a href="../m/info.php?menu=Member_info" data-transition="flip">ข้อมูลส่วนตัว</a></li>
            <!--<li><a href="../m/info.php?menu=Beneficiary" data-transition="flip">ผู้รับผลประโยชน์</a></li>-->
            <li><a href="../m/info.php?menu=Change_Pwd" data-transition="flip">เปลี่ยนรหัสผ่าน</a></li>
...
<ul data-role="listview" >
    <li  data-theme="f"><a href="../m/info.php?menu=News" data-transition="flip">ข่าวสารสมาชิก</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=Share" data-transition="flip">ข้อมูลหุ้น</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=Deposit" data-transition="flip">ข้อมูลเงินฝาก</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=Loan" data-transition="flip">ข้อมูลเงินกู้</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=LoanPermission" data-transition="flip">สิทธิ์กู้</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=Ref_collno" data-transition="flip">ข้อมูลค้ำประกัน</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=Payment" data-transition="flip">รายการหักประจำเดือน</a></li>
    <li  data-theme="f"><a href="../m/info.php?menu=Dividend" data-transition="flip">ปันผล-เฉลี่ยคืน</a></li>
	    <li  data-theme="f"><a href="../m/info.php?menu=Fund" data-transition="flip">ข้อมูลกองทุน</a></li>
	<li  data-theme="f"><a href="../m/info.php?menu=Member_info" data-transition="flip">ข้อมูลส่วนตัว</a></li>
	<!--<li  data-theme="f"><a href="../m/info.php?menu=Beneficiary" data-transition="flip">ผู้รับผลประโยชน์</a></li>-->
        <li  data-theme="f"><a href="../m/info.php?menu=Change_Pwd" data-transition="flip">เปลี่ยนรหัสผ่าน</a></li>
    <li  data-theme="a"><a href="../m/info.php?menu=SigeOut" data-rel="dialog" data-theme="a" >ออกจากระบบ</a></li>	
</ul>
