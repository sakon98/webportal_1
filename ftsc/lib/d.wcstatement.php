...
<br />
<?php
require "../s/s.wcstatement.php";
?>
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right"><font face="Tahoma" size="4"><strong>ข้อมูลการเรียกเก็บเงิน</strong></font><br />
      <font face="Tahoma" size="2" color="#FF6600">Statement</font></td>
  </tr>
  <tr>
    <td align="right"><hr color="#999999" size="1"/></td>
  </tr>  
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr>
            ...
            <td width="40%" align="left" bgcolor="#CCCCFF"><strong>รายการ</strong></td>
            <td width="15%" align="right" bgcolor="#CCCCFF"><strong>จำนวนเงิน</strong></td>
            <td width="15%" align="right" bgcolor="#CCCCFF"><strong>ยอดคงเหลือ</strong></td>
          </tr>
          <?php 
          ...
          <tr>
            ...
            <td height="25" align="center" bgcolor="#FFFFFF"><?=ConvertDate($operate_date[$i] ,"short")?></td>
            <td align="left" bgcolor="#FFFFFF"><?=$deptitemtype_desc[$i]?></td>
            <td align="right" bgcolor="#FFFFFF"><?=$deptitem_amt[$i]?></td>
            <td align="right" bgcolor="#FFFFFF"><?=$prncbal_[$i]?></td>
          </tr>
          <?php } ?>
        </table>
    </td>
