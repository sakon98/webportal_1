...
CREATE TABLE IF NOT EXISTS `log_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=tis620 AUTO_INCREMENT=8 ;
...
(1, 'Login', NULL, NULL, '193730', '112.121.152.149', '2017-09-27 12:22:03', 'desktop'),
(2, 'Login', NULL, NULL, '193730', '112.121.152.149', '2017-09-27 12:23:47', 'desktop'),
(3, 'Login', NULL, NULL, '193730', '112.121.152.149', '2017-09-27 14:29:09', 'desktop'),
(4, 'Login', 'bypass', NULL, 'administrator', '112.121.152.149', '2017-09-27 14:38:18', 'desktop'),
(5, 'news', 'Add', '3', 'administrator', '112.121.152.149', '2017-09-27 14:39:57', 'desktop'),
(6, 'news', 'update', '3', 'administrator', '112.121.152.149', '2017-09-27 14:40:30', 'desktop'),
(7, 'news', 'update', '3', 'administrator', '112.121.152.149', '2017-09-27 14:41:07', 'desktop');
...
INSERT INTO `mbmembmaster` (`member_no`, `memb_fullname`, `idcard`, `email`, `mobile`, `password`, `date_reg`, `ipconnect`, `confirm_date`, `who_approve`) VALUES
('193730  ', 'นางสุพัตรา   ดวงเกษมสุข  ', '3240500094121', '245/3 ถ.รามคำแหง ต.หัวเดียด อ.เมืองตาก จ.ตาก', '0873131048', '241c6d73db0339e508922acb36efb738', '2017-09-27 12:19:07', '112.121.152.149', NULL, NULL);
...
INSERT INTO `news` (`id`, `n_topic`, `n_details`, `n_date`, `count_edit`, `who_post`, `who_edit`) VALUES
(3, 'สมาชิก สส.ชสอ สามารถดูข้อมูลส่วนตัวผ่าน Mobile App ได้ ', 'โดยสามารถ Download Application ได้ที่ <a href="https://play.google.com/store/apps/details?id=isocare.coop.member" target="_blank">Link </a>\r\n', '2017-09-27 14:41:07', 2, 'administrator', 'administrator');
