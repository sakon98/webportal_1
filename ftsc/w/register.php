...
6.ข้าพเจ้าได้อ่านข้อตกลงดังกล่าวแล้ว และยินยอมในเงื่อนไขต่างๆที่ทาง <?=$title?> กำหนดไว้
            ...
            <form name="formID1" id="formID1" method="post" action="" >
              <table><tr><td><input name="agree" type="checkbox" class="validate[required]" id="agree" value="agree" placeholder="ข้าพเจ้ายอมรับเงิ่อนไขทั้งหมด"  /></td>
			  <td><font face="Tahoma" size="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้าพเจ้ายอมรับเงิ่อนไขทั้งหมด</font></td></tr></table>
              <input name="member_no" type="text" class="validate[required,custom[integer]]" id="member_no" size="20" maxlength="10" autocomplete="off" placeholder="ทะเบียนสมาชิก"  />
              <input name="idchk" type="text" class="validate[required,custom[integer],minSize[13]]" id="idchk" size="20" maxlength="13" autocomplete="off" placeholder="เลขที่บัตรประชาชน" />
