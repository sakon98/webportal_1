...
<div data-role="content" align="center">
					   ...
					   <form name="form" method="post" action="">
						<input type="text" name="idcard" id="idcard" value=""  placeholder="เลขบัตรประชาชน" autocomplete="off" >
						<input type="hidden" name="usr" id="usr" value=""  placeholder="ทะเบียนสมาชิก" autocomplete="off" >
						<input type="hidden" name="pwd" id="pwd" value="" placeholder="รหัสผ่าน" autocomplete="off"> 
					    <input value="เข้าสู่ระบบ" data-iconpos="right" data-theme="b" type="submit">
				        </form>
						<!--<center><img src="../img/qrcode.png" width="100" /> </center> <br/>-->					   
					    <input  id="register" name="register"  value="สมัครใช้บริการ" data-iconpos="right" data-theme="c" type="hidden" onclick="window.location='register.php';">
