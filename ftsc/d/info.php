    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        ...
        <table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="140" height="105" align="right"><img src="../img/logo_.png" width="138" height="100"></td>
      ...
      <tr>
        <td width="170" valign="top" bgcolor="#CCCCCC"><?php require "../lib/menu.php" ?></td>
          ...
          <tr>
			...
			<?php
				if($_REQUEST["menu"] == "Member_info"){
					require "../lib/d.wcmember_info.php";
				}else if($_REQUEST["menu"] == "MemberCredit"){
					require "../lib/d.wccredit.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Codept"){
					require "../lib/d.wccodept.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Statement"){
					require "../lib/d.wcstatement.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "TrnDetail"){
					require "../lib/d.wctrndetail.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == ""){
