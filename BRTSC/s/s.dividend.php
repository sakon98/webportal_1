...
<?php
	$strSQL = "SELECT MAX(Y.DIV_YEAR) AS MAXDIV ,MIN(Y.DIV_YEAR) AS MINDIV 
FROM YRDIVMASTER Y LEFT JOIN YRCFRATE YR ON Y.DIV_YEAR = YR.DIV_YEAR
WHERE Y.MEMBER_NO = '$member_no' AND YR.WEBSHOW_FLAG = 1 ";
