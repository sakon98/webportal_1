...
<?php
//echo $member_no;
$strMySQL = "SELECT COUNT(DISTINCT member_no) AS sum_member  FROM webmbmembmaster";
$valueSQL = "sum_member";
$sum_member = get_single_value_sql($strMySQL,$valueSQL);

if($confirm2use == 1){	
	$strMySQL = "SELECT COUNT( DISTINCT member_no ) AS sum_approve FROM webmbmembmaster
