...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"class="txtShadow1"bgcolor="#87CEFF">
            ...
            <option value=""> --- รอบปันผลฯ ---</option>
                  <?php  					  
                    for($i=0  ; $i <= ($maxdiv-$mindiv) ; $i++)
					{
						...
						{
							$txtMaxDiv = $maxdiv-$i;
							$txtY = substr($txtMaxDiv,0,4);			//  ปี
							$txtN = substr($txtMaxDiv,4,5);			//  รอบที่
							
							//  เปอร์เซ็นปันผล-เฉลี่ยคืนแต่ละปี
							...
							if ($txtN>0 AND $txtN<3){echo '<option value="'.($maxdiv-$i).'">ปี :  '.$txtY.' รอบที่ '.$txtN.'</option>';}
						}
                    }		//  END for(...)
                   ?>
    	</select>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
	...
	<table width="95%" border="0" align="center" cellpadding="5" cellspacing="3"class="txtShadow2">
	  <tr>
		<td width="50%" height="35" align="center" bgcolor="#A8F552"><font face="AngsanaUPC"size="+3"><b>ปันผล</b> ( <?=$txtDiv;?> % )</font></td>
		<td width="50%" align="center" bgcolor="#A8F552"><font face="AngsanaUPC"size="+3"><b>เฉลี่ยคืน</b> ( <?=$txtAvg;?> % )</strong></td>
	  </tr>
	  <tr>
		<td height="35" align="center">
			<font face="AngsanaUPC"size="+4"color="#3232FF"><b><?=$div_balamt?>&nbsp;&nbsp;<font size="+3"color="#555555">บาท</font></b></font>
		</td>
		<td align="center">
			<font face="AngsanaUPC"size="+4"color="#3232FF"><b><?=$avg_balamt?>&nbsp;&nbsp;<font size="+3"color="#555555">บาท</font></b></font>
		</td>
	  </tr>
	  <tr>
		<td height="35" colspan="2" align="center" bgcolor="#A8F552"><font face="AngsanaUPC"size="+3" ><strong>รวม ปันผล-เฉลี่ยคืน&nbsp;&nbsp;&nbsp;=&nbsp;&nbsp;&nbsp;
		<font face="AngsanaUPC"size="+4" color="#FF6633"> <?=$sumdiv?> </font>&nbsp;&nbsp;&nbsp; บาท</strong></font></td>
	  </tr>
