...
<tr bgcolor="#00008C"><td height="20"valign="middle"><font style="font-size:12px;"color="#ffffff">เลือกรายการจากเมนูด้านล่าง</font></td></tr>
...
<?php } ?>    
	<tr><td>&nbsp;</td></tr>
	<tr bgcolor=""><td height="30" bgcolor="#555555"><strong><a href="info.php?menu=SigeOut" onclick="return confirm('ท่านต้องการออกจากระบบบริการสมาชิก ใช่ หรือ ไม่ ?');">ออกจากระบบ</a></strong></td></tr>
</table>
</span>