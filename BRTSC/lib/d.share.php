...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="6"class="share1">
  <tr>
    <td width="38%" height="35" align="center" bgcolor="#CCCCFF">
	หุ้นสะสมรวม&nbsp;&nbsp;<font color="#FF5500"size="+3"><strong><?= number_format($SHARE_AMT,2) ?></strong></font>&nbsp;&nbsp;บาท</td>
    <td width="37%" align="center" bgcolor="#CCCCFF">
	ส่งหุ้นงวดละ&nbsp;&nbsp;<font color="#FF5500"size="+3"><strong><?= number_format($PERIODSHARE_AMT,2) ?></strong></font>&nbsp;&nbsp;บาท</td>
    <td width="25%" align="center" bgcolor="#CCCCFF">
	งวดปัจจุบัน&nbsp;&nbsp;<font color="#FF5500"size="+3"><strong><?= $LAST_PERIOD ?></strong></font></td>
  </tr>
</table>
<br />
<?php
