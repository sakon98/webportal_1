...
<?php 
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<p>เปลี่ยนรหัสสมาชิกให้เป็น <font size="4" color="#FF0000">&quot;<?=$_SESSION[ses_repwd];?>&quot;</font>    </p>
	...
	if($_POST["button"] == "ยืนยัน")
	{
		...
		$status = update_value_sql($table,$condition,$value);
			...
			{		
				...
				echo '<script type="text/javascript"> window.alert("ระบบได้แก้ไขแล้วให้สมาชิกใช้ รหัสผ่าน '.$_SESSION[ses_repwd].'เพื่อเข้าไปไปตั้งรหัสผ่านใหม่") </script> ';
