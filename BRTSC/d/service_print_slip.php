            ...
            <td align="right" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td width="12%" height="45" align="center"><font face='Tahoma' size="5"><strong>
                  <img src="../img/logo1_kls.png" alt="" width="80" height="80"></strong></font><br/></td>
...
<table width="101%" border="0" cellspacing="1" cellpadding="6">
  <tr>
    <td align="center">
    <form id="form3" name="form1" method="post" action="">
   		<input name="b_print2" type="button" class="ipt; button1"  onclick="printdiv('div_print1'),location.href='service.php'" value="พิมพ์"  />&nbsp;&nbsp;
          <input name="b_print" type="button" class="button2" onClick="location.href='service.php';" value="ออกจากระบบ"  />
    </form>
    </td>
  </tr>
</table>
