            ...
            <form name="formID1" id="formID1" method="post" action="" >
              <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  ...
                  <td width="61%"><input name="member_no" type="text" class="validate[required,custom[integer]]" id="member_no" size="20" maxlength="10" autocomplete="off" style="width: 161px;"/><font color="#FF0000"> ** ไม่ต้องใส่เลขศูนย์นำหน้า</font></td>
                </tr>
                <tr>
