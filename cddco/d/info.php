...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        <td height="110" colspan="2" background="../img/head_info_bg.png">
        <table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="109" height="105" align="right"><img src="../img/logo.gif" width="101" height="101"></td>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="6">
          <tr>
			...
			<?php
				...
				}else if($_REQUEST["menu"] == "Calculator"){
