...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right"><font face="Tahoma" size="4"><strong>ข้อมูลผู้รับโอนประโยชน์</strong></font><br />
      <font face="Tahoma" size="2" color="#FF6600">Beneficiary</font></td>
  </tr>
...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="4">
    <td align="left" valign="top"><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="5%" valign="top">&nbsp;</td>
        <td width="95%" valign="top"><font face="Tahoma" size="3"><?=$i + 1 . '.' .$gain_name[$i]?></font></td>
      </tr>
      
            <?php } ?>
		<!--<tr>
        <td colspan="2" valign="top"><font color="red"><h4>* ขณะนี้อยู่ระหว่างการปรับปรุงข้อมูล</h4></td>
      </tr>	-->
