...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<tr><td align="right">โทร 053-712585<br>053-756203</td></tr>
	<tr>
        <td valign="top">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="1">
                <tr>
                  <td width="12%"><strong>เลขที่ใบเสร็จ</strong></td>
                  <td width="40%"><?=$slip_no ?> </td>
                  <td width="12%"><strong>วันที่</strong></td>
                ...
                <tr>
                  ...
                  <td><strong>ทุนเรือนหุ้นสะสม</strong></td>
		...
		<tr>
			<td>
				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td align="left"><strong><fontface="Tahoma">ข้อมูลการค้ำประกัน</font></strong><br />
					</tr>
				</table><br>
