...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td width="12%" height="33" align="center" bgcolor="#CCCCFF"><strong>วันที่ใบเสร็จ</strong></td>
        <td width="12%" align="center" bgcolor="#CCCCFF"><strong>วันที่ทำรายการ</strong></td>
        <td width="12%" align="center" bgcolor="#CCCCFF"><strong>รหัสทำรายการ</strong></td>
        <td width="12%" align="center" bgcolor="#CCCCFF">&nbsp;</td>
        <td width="12%" align="center" bgcolor="#CCCCFF"><strong>ฝาก</strong></td>
		<td width="12%" align="center" bgcolor="#CCCCFF"><strong>จำนวนหุ้น</strong></td>
        <td width="13%" align="center" bgcolor="#CCCCFF"><strong>ยอดคงเหลือ</strong></td>
        <td width="41%" align="center" bgcolor="#CCCCFF"><strong>หมายเหตุ</strong></td>
      </tr>
    <?php for($i=0;$i<$Num_Rows;$i++){ ?>
      <tr>
        ...
        <td align="right" bgcolor="#FFFFFF"></td>
        <?php }?>
		<td align="right" bgcolor="#FFFFFF"><?=number_format($sharestk_amt_balance[$i],2)?></td>
