...
<?php
	...
	$value = array('LOANCONTRACT_NO','PRENAME_DESC','MEMB_NAME','MEMB_SURNAME','MEMBER_NO','PRINCIPAL_BALANCE','RESIGN_STATUS');
   ...
   $strSQL2 = " SELECT LCC.COLLACTIVE_AMT
	...
	for($i=0;$i<$Num_Rows1;$i++){
		...
		$coll_loan_group[$i] = $list_info[$i][$j++];
		$coll_loan_principal_balance[$i] = $list_info[$i][$j++];
		$j=0;
