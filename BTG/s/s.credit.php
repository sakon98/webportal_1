...
*/
$strSQL="alter table lnloantype add active_flag number(1,0) default 1 not null ";
...
$strSQL = "select 
					...
					,case when
						(s.sharestk_amt*sh.unitshare_value*l.percentshare ) + (nvl(m.salary_amount,15000)*l.percentsalary ) >  l.maxloan_amt then
					     l.maxloan_amt 
                       else 
                           (s.sharestk_amt*sh.unitshare_value*l.percentshare ) + (nvl(m.salary_amount,15000)*l.percentsalary ) 
					end 
					 as credit_amt
					, (s.sharestk_amt*sh.unitshare_value*l.percentshare ) + (nvl(m.salary_amount,15000)*l.percentsalary ) as credit_amt_
					,s.sharestk_amt
					,sh.unitshare_value
					,l.percentshare
					,l.percentsalary
				...
				where m.member_no='$member_no'  
					...
					and LT.LOANGROUP_CODE in ( '01','02' ) and lt.active_flag = 1 
