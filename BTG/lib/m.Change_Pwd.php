...
<form id="formID1" name="formID1" method="post" action="">
	...
	<strong><font size="2" face="Tahoma" color="#FF0000">กำหนดรหัสผู้ใช้ใหม่อย่างน้อย 6 ตัวอักษร<br/> แต่ไม่เกิน 13 ตัวอักษร</font></strong>
	<input name="npwd" type="password" class="validate[required,minSize[6]]" id="npwd" size="25" maxlength="14" autocomplete="off"  placeholder="รหัสผ่านใหม่"/>
	<input name="npwd1" type="password" class="validate[required,equals[npwd]]" id="npwd1" size="25" maxlength="14" autocomplete="off"  placeholder="รหัสผ่านใหม่(ยืนยัน) "/>
