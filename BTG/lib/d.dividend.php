...
<?php  require "../s/s.dividend1.php";  ?>
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="86%" align="left"><strong><font size="4" face="Tahoma">ปันผล - เฉลี่ยคืน  <?//=$divyear?></font></strong><br />
    <font color="#0000FF" size="2" face="Tahoma">Dividend & Returning</font></td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td width="13%" height="33" align="center" bgcolor="#C2E0B6"><strong>ปีที่ได้รับปันผล</strong></td>
        <td width="13%" align="center" bgcolor="#C2E0B6"><strong>ปันผลที่ได้รับ</strong></td>
        <td width="13%" align="center" bgcolor="#C2E0B6"><strong>เฉลี่ยคืนที่ได้รับ</strong></td>
        <!--<td width="13%" align="center" bgcolor="#CCCCFF"><strong>รายการหัก</strong></td>-->
        <td width="13%" align="center" bgcolor="#C2E0B6"><strong>จำนวนเงินรวม</strong></td>
      </tr>
    <?php for($i=0;$i<$Num_Rows;$i++){ ?>
      <tr>
        <td height="27" align="center" bgcolor="#FFFFFF"><?=$DIV_YEAR[$i]?></td>
        <td align="right" bgcolor="#FFFFFF"><?=$DIV_BALAMT[$i]?></td>
        <td align="right" bgcolor="#FFFFFF"><?=$AVG_BALAMT[$i]?></td>
        <!--<td align="right" bgcolor="#FFFFFF"><?//=$ETC_BALAMT[$i]?></td>-->
        <td align="right" bgcolor="#FFFFFF"><?=$SUMDIV[$i]?></td>
      </tr>
      <?php } ?>
    </table></td>
  </tr>
...
<table width="75%" border="0" align="center" cellpadding="0" cellspacing="3">
  ...
  <tr>
    <td align="right"><font color="#0000FF">* กรุณาตรวจสอบอีกครั้งกับทางสหกรณ์</font></td>
  </tr>
</table>
