...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="13%" align="center" bgcolor="#FAE4EE"><strong><font color="#000000">มีภาระค้ำประกัน</font></strong></td>
    <td width="88%" bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="5">
      <tr>
        <td width="20%" align="center" bgcolor="#FAE4EE">สัญญาเลขที่</td>
        <td width="56%" align="center" bgcolor="#FAE4EE">ชื่อ-สกุล (ทะเบียนสมาชิก)</td>
       <!-- <td width="24%" align="center" bgcolor="#FFCC33">หนี้คงเหลือ</td> -->
        <td width="24%" align="center" bgcolor="#FAE4EE">ยอดคงเหลือ(บาท)</td>
      </tr>
...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="13%" align="center" bgcolor="#D0D0E9"><strong><font color="#000000">หลักประกัน</font></strong></td>
    <td width="88%" bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="5">
      <tr>
        <td width="20%" align="center" bgcolor="#D0D0E9">สัญญาเลขที่</td>
        <td width="56%" align="center" bgcolor="#D0D0E9">ชื่อ-สกุล (ทะเบียนสมาชิก)</td>
        <td width="24%" align="center" bgcolor="#D0D0E9">ยอดคงเหลือ(บาท)</td>
      </tr>
...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="3">
  <tr>
    <td align="right"><font color="#0000FF">* ระบบจะแสดงเฉพาะสัญญาที่มี <strong>บุคคล</strong>  ค้ำประกันเท่านั้น</font></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
  </tr>
