...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
       ...
       <?php require "../s/s.share4.php"; ?>
      <?php for($b=0;$b<$Num_Rows;$b++){?>
      
    <td align="left"><strong><font size="4" face="Tahoma">ข้อมูลหุ้น <font color="#0000FF"><?php echo $show_date; ?></font></font></strong><br />
        
              <?php } ?>
        
    <font color="#0000FF" size="2" face="Tahoma">Share</font></td>
  </tr>
  <tr>
...
<table width="85%" border="0" align="center" cellpadding="1" cellspacing="6">
  <tr>
    <td width="32%" height="35" align="center" bgcolor="#CCCCFF">หุ้นสะสมรวม <font color="#0000FF"><strong><?= number_format($SHARE_AMT,2) ?></strong></font> บาท</td>
    <td width="40%" align="center" bgcolor="#CCCCFF">ส่งหุ้นงวดละ <font color="#0000FF"><strong><?= number_format($PERIODSHARE_AMT,2) ?></strong></font> บาท</td>
    <td width="28%" align="center" bgcolor="#CCCCFF">งวดปัจจุบัน <font color="#0000FF"><strong><?= $LAST_PERIOD ?></strong></font></td>
  </tr>
</table>
<br />
<?php
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <font color="#0000FF" size="2" face="Tahoma">Share Statment</font></td>
  ...
  <tr>
    <td bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        ...
        <td width="33%" align="center" bgcolor="#CCCCFF"><strong>รายการ</strong></td>
        <td width="13%" align="center" bgcolor="#CCCCFF"><strong>จำนวนงวด</strong></td>
