...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="97%" align="left"><strong><font size="4" face="Tahoma">ข่าวประชาสัมพันธ์</font></strong><br />
    ...
    <div class="popup-box" id="popup-abox-1">
        <div class="close">X</div>
        	<div class="top" align="left">
            	...
            	<font face="Tahoma" size="2" color="#0000FF">Add News</font>           
            </div>
        ...
        <div class="bottom">
            ...
            <textarea name="details" id="details" style="width:100%; resize:none; font-size:14px; font-family:Tahoma"  rows="10"></textarea><br><br>
            <label for="file">เลือกอัพโหลดไฟล์</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="file" name="filUpload"><br><br>
            <label for="file">เลือกอัพโหลดรูปภาพ 1</label>&nbsp;&nbsp;
            <input type="file" name="filUploadimg1"><br><br>
            <label for="file">เลือกอัพโหลดรูปภาพ 2</label>&nbsp;&nbsp;
            <input type="file" name="filUploadimg2">
            <br><br>
            <div align="right">
...
<?php 	for($i=0;$i<$Num_Rows;$i++){ ?>
  <tr>
    ...
    <div class="popup-box" id="popup-box-<?=$i?>">
        <div class="close">X</div>
            <div class="top" align="left">
                <strong><font size="4" face="Tahoma">ข่าวประชาสัมพันธ์</font></strong><br />
            	<font face="Tahoma" size="2" color="#0000FF">News</font>           
            </div>
            <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
            <div class="bottom" >
                ...
                <div align="right">ผู้ประกาศ  : <font face="Tahoma" size="2" color="#0000FF"><?= $who_post[$i]?></font>
                    &nbsp;&nbsp;&nbsp;วันที่ประกาศ : <font face="Tahoma" size="2" color="#0000FF"><?= DateThai($n_date[$i])?></font></div><br>
                 <label for="file">เลือกอัพโหลดไฟล์</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="file" name="filUpload"><br><br>
            <label for="file">เลือกอัพโหลดรูปภาพ 1</label>&nbsp;&nbsp;
            <input type="file" name="filUploadimg1"><br><br>
            ...
            <br><br>
                 ...
                 <input name="table" type="hidden" value="news" />
             </div>
      </form>
        </div>
...
//echo "Copy/Upload Complete<br>";
 ...
 Insert Record 
$objConnect = mysql_connect("localhost","root","WebServer") or die("Error Connect to Database");
$objDB = mysql_select_db("ptt");
$strSQL = "update news set FilesName = '".$_FILES["filUpload"]["name"]."' where id = '$id[$i]'";
