...
/*(case when l.action_do = 'Change Password' then 'Change Password' 
      when l.action_do = 'For_Got_Password' then 'ลืมรหัสผ่าน'
...
where (l.action_do in ('Change Password','For_Got_Password','Reset Password','Login','Login Fail','SigeOut') and l.user = '$name' and l.action_desc is null) order by l.date_log desc";
