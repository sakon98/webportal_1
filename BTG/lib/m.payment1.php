...
<ul data-role="listview" data-inset="true">
    ...
    <li>
        <p><strong><?=($i+1).'. '?><?=$slip_itemdesc[$i].' '.$slip_loanno[$i].($period[$i]!=""?(' งวดที่ '.$period[$i]):"")?></strong></p>
         <?php if($itembalance[$i] != null){  ?><p align="left">คงเหลือ  <?=$itembalance[$i]?> ฿</p> <?php } ?>
...
<center><div ><a href="info.php?menu=Payment" data-role="button" data-corners="false"  data-icon="arrow-l" data-theme="b">กลับไป </a></div></center>
