...
<!--<form id="form3" name="form1" method="post" action="">
   ...
   $appl_docno = $_GET['appl_docno']; 
						  ...
						  $strSQL = "select TO_CHAR(sysdate, 'DD/MM/YYYY','NLS_CALENDAR=''THAI BUDDHA') as date_now,
                                                ...
                                                muc.gain_concern, 
                                                mb.referaddr_phone,ftreadtbath(mb.periodshare_value) as ftreadtbath 
                                                from mbreqappl mb, 
                                                mbucfprename mup,
                                                mbucfmembgroup mug,
                                                mbucfposition mut,
                                                ...
                                                mbucfprovince mp,
                                                mbucfprovince mp1
                                                where mb.appl_docno = '$appl_docno' and 
                                                ...
                                                mb.referprovince_code = mp1.province_code(+)";
...
เขียนที่ ....................................................... </center></div>
 ...
 <div id="pp">ขอให้ถ้อยคำเป็นหลักฐานดังต่อไปนี้</div><br> 
  ...
  <div id="pp">โทรศัพท์ที่ติดต่อ ...................................... ผลประโยชน์คิดเป็น  &nbsp;&nbsp; <?php echo $gain_percent; ?>%</div><br><br>
  
 
   <!--<div id="pp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ข้าพเจ้ารับทราบ &nbsp;และยินยอมให้สหกรณ์ออมทรัพย์พนักงานเครือเบทาโกร จำกัด&nbsp;&nbsp;เก็บรวบรวม&nbsp;ใช้&nbsp;&nbsp;หรือเปิดเผยข้อมูลส่วนบุคคล</div>
   <div id="pp">ของข้าพเจ้า&nbsp;&nbsp;เพื่อประโยชน์แก่ข้าพเจ้าในฐานะผู้สมัครเป็นสมาชิกสหกรณ์ฯ รวมถึงประโยชน์ในการจัดทำฐานข้อมูล  และใช้ข้อมูลเพื่อเสนอ</div>
   <div id="pp">สิทธิประโยชน์ตามความสนใจของข้าพเจ้ากับเพื่อประโยชน์ในการติดต่อประสานระหว่างระบบงานทรัพยากรมนุษย์กับระบบงานสหกรณ์ฯ</div>
   <div id="pp">ตามกฎหมายและ/หรือเพื่อปฏิบัติตามกฎหมายหรือกฎระเบียบที่ใช้บังคับอยู่ทั้งขณะนี้และภายภาคหน้า  รวมทั้งยินยอมให้สหกรณ์ฯ  จัดเก็บ </div>
   <div id="pp">ใช้ ส่ง โอน และ/หรือเปิดเผยข้อมูลส่วนบุคคลให้แก่บริษัทฯ กลุ่มธุรกิจของบริษัทในเครือเบทาโกร  ผู้ให้บริการภายนอก  ผู้ประมวลผลข้อมูล </div>
   <div id="pp">หน่วยงาน/องค์กร/นิติบุคคล ใดๆที่มีสัญญาอยู่กับสหกรณ์ฯ  มีนิติสัมพันธ์หรือมีความสัมพันธ์ใดๆ &nbsp;กับสหกรณ์ฯด้วย&nbsp;และยินยอมให้สหกรณ์ </div>  
   <div id="pp">จัดเก็บ ใช้ ส่ง โอน และ/หรือเปิดเผยข้อมูลดังกล่าวทั้งในประเทศและต่างประเทศ เท่าที่ไม่เป็นการฝ่าฝืนกฎหมาย </div> <br><br><br>
