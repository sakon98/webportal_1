        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td align="right" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td width="13%" height="45" align="center"><font face='Tahoma' size="5"><strong>
                  <img src="../img/logo.png" alt="" width="100" height="100"></strong></font><br/></td>
                <td width="73%" align="center"><font face='Tahoma' size="4"><strong>
                  <?=$title?>
                </strong></font><br/>
                <font face='Tahoma' size="4"><strong>ใบเสร็จรับเงิน </strong></font></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center"><table width="100%" border="0" cellspacing="6" cellpadding="1">
                <tr>
                  ...
                  <td width="20%" align="right"><strong>คงเหลือ</strong></td>
                </tr>
              </table></td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="center"><table width="95%" border="0" cellspacing="3" cellpadding="1">
                <tr>
                  <td width="17%" align="center" valign="middle"><strong>ผู้จัดการ</strong></td>
                  <td width="34%" height="50" align="left" valign="middle"><img src="../img/mg.png" width="80" height="80"></td>
                  <td width="17%" align="center" valign="middle"><strong>เจ้าหน้าที่ผู้รับเงิน</strong></td>
                  <td width="32%" align="center" valign="middle"><img src="../img/fn.png" width="80" height="80"></td>
                </tr>
                <tr>
