...
$strSQL9 = "SELECT last_documentno + 1 as last_documentno from cmdocumentcontrol where document_code = 'MBAPPLDOCNO'";  // คิวรี่เอาค่า last docno + 1 ไปยิงกลับ cmdocumentcontrol
 ...
 $strSQL10 = "select document_prefix , substr(document_year,3,2) as document_year , last_documentno + 1 as  appl_docno1,coop_id from cmdocumentcontrol where document_code = 'MBAPPLDOCNO'";  // คิวรี่ปั้นเลขที่ใบคำขอสมาชิก
						...
						oci_execute ($objParse10,OCI_DEFAULT);
							while($objResult10 = oci_fetch_array($objParse10,OCI_BOTH)){
                                                        ...
                                                        $appl_docno1 = $document_year.$appl_docno1;
...
$last_documentno; // นำไปยิงกลับใส่ cmdocumentcontrol
//$appl_docno; // นำไปใช้เป็น เลขที่ใบคำขอสมาชิก
//$appl_docno = $_POST["doc_no"];
