...
<head>
	...
	function check() {
	 ...
	 // disabled text
		...
		document.getElementById("position_work").disabled = true; // สถานที่ปฏิบัติงาน
           ...
           <td align="center"><table width="1000px" style="height:390;" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr >
                <td style="opacity: 0.85;" align="left" bgcolor="#FFFFFF">
                   ...
                   <select id="membgroup_code" name="membgroup_code" style="width:400px;" class="inputs" disabled required>
					...
					<input name="membgroup_code2" id="membgroup_code2" type="hidden" style="width:355px;" class="inputs" placeholder="สังกัด">
					<br>
					...
					<input name="nationality" id="nationality" type="text" style="width:180px;" class="inputs" placeholder="สัญชาติ" value = "ไทย"  readonly required>
					<br>
					...
					<br>
					<fieldset>
					<legend style="color:#FF0000;font-size:medium;">**ข้อควรทราบในการสมัครสมาชิกสหกรณ์**</legend>
					
					<p style="font-size:14"> <input name="agree" type="checkbox" id="agree" value="agree" required>
					&nbsp;&nbsp;&nbsp;&nbsp;ข้าพเจ้ารับทราบ และยินยอมให้สหกรณ์ออมทรัพย์พนักงานเครือเบทาโกร จำกัด เก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลของข้าพเจ้า 
					เพื่อประโยชน์แก่ข้าพเจ้าในฐานะผู้สมัครเป็นสมาชิกสหกรณ์ฯ รวมถึงประโยชน์ในการจัดทำฐานข้อมูล และใช้ข้อมูลเพื่อเสนอสิทธิประโยชน์ตามความสนใจของข้าพเจ้า
					กับเพื่อประโยชน์ในการติดต่อประสานระหว่างระบบงานทรัพยากรมนุษย์กับระบบงานสหกรณ์ฯตามกฎหมายและ/หรือเพื่อปฏิบัติตามกฎหมายหรือกฎระเบียบที่ใช้บังคับ
					อยู่ทั้งขณะนี้และภายภาคหน้า รวมทั้งยินยอมให้สหกรณ์ฯ จัดเก็บ ใช้ ส่ง โอน และ/หรือเปิดเผยข้อมูลส่วนบุคคลให้แก่บริษัทฯ กลุ่มธุรกิจของบริษัทในเครือเบทาโกร ผู้ให้บริการภายนอก 
					ผู้ประมวลผลข้อมูล หน่วยงาน/องค์กร/นิติบุคคล ใดๆที่มีสัญญาอยู่กับสหกรณ์ฯ มีนิติสัมพันธ์หรือมีความสัมพันธ์ใดๆกับสหกรณ์ฯด้วย และยินยอมให้สหกรณ์จัดเก็บ 
					ใช้ ส่ง โอน และ/หรือเปิดเผยข้อมูลดังกล่าวทั้งในประเทศและต่างประเทศ เท่าที่ไม่เป็นการฝ่าฝืนกฎหมาย</p> <br>
					</fieldset>
						  ...
						  <input type="submit" onclick="location.href='search_reprint_register_test.php';" value="Reprint" class="button4" style="width: 104px;"/>
   ...
   var percent = 100;
	...
	$('#member_no').change(function(){
		...
		$.post('../s/s.retrivemember.php',{
			...
			}else  if (obj.emp_name == "2" || obj.emp_ename == "2" || obj.emp_esurname == "2" || obj.prename == "2" || obj.emp_surname == "2" || obj.sex == "2" || obj.adn_email == "2" || obj.id_card == "2" || obj.salary_amt == "2" || obj.birth_date == "2" || obj.contain_date == "2" || obj.nation == "2" || obj.level_code == "2" || obj.membgroup_code == "2" || obj.adn_tel == "2" || obj.adn_postcode == "2" || obj.work_str_date == "2" || obj.position_work == "2" || obj.province_code == "2" || obj.district_code == "2" || obj.tambol_code == "2" || obj.position_code == "2"){
				
				alert("ท่านยังไม่เป็นพนักงานบริษัทไม่สามารถสมัครสมาชิกสหกรณ์ได้  !! ");
			...
			$('#membgroup_code2').val(obj.membgroup_code);
		...
		document.getElementById("position_work").readOnly = true;
		
		   }else{

			alert("ไม่สามารถดึงข้อมูลได้ ข้อมูลสัญชาติไม่ใช่ สัญชาติไทย");
...
$('#card_person').blur(function(){

   if(!checkID(document.formID1.card_person.value) && document.formID1.card_person.value != "")
   {
       
alert('รหัสประชาชนไม่ถูกต้อง');


document.getElementById('card_person').value = '';
