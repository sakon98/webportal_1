        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="6">
          <tr>
             <td align="center"><table width="75%" border="1" align="center" bordercolor = "green" cellpadding="20" cellspacing="0">
					<tr><td><B>
                                                    <font color = "blue" size="2"> เงื่อนไขและข้อตกลงในการสมัครใช้บริการ </font><br>

					1.การเข้าใช้งานระบบข้อมูลสมาชิกจะต้องทำการสมัครเข้าใช้งานระบบและต้องเป็นสมาชิกของ สหกรณ์ออมทรัพย์พนักงานเครือเบทาโกร จำกัด เท่านั้น <br>
                                        2.เพื่อความเรียบร้อยในการสมัครใช้งาน ระบบฯ และเพื่อยืนยันผู้สมัคร กรุณาทำตามขั้นตอนที่ระบบแนะนำ <br>
                                        3.หากปรากฏว่า ชื่อหรือหมายเลขสมาชิก ของท่านได้มีการสมัครใช้งานแล้ว โดยท่านไม่ทราบ หรือทำการสมัครด้วยตัวท่านเอง กรุณาแจ้งเจ้าหน้าที่เพื่อทำการตรวจสอบความถูกต้อง ต่อไปกรุณาเก็บรักษา username / password ของท่าน <br>
                                        4.เพื่อสิทธิและความปลอดภัยในข้อมูลของท่านเองหากปรากฏว่ามีบุคคลแอบอ้าง สมัครใช้งานระบบและเจ้าหน้าที่ตรวจสอบแล้วจะทำการลบรายชื่อนั้นๆ ออกจากระบบ โดยไม่ต้องแจ้งให้ทราบ <br>
                                        5.ข้อมูลของสมาชิก ในระบบจะทำการปรับปรุงข้อมูล หากสมาชิกท่านใดพบข้อมูลไม่ตรงหรือมีข้อสงสัยกรุณาติดต่อเจ้าหน้าที่ <br>
                                        6.ข้าพเจ้าได้อ่านข้อตกลงดังกล่าวแล้ว และยินยอมในเงื่อนไขต่างๆที่ทาง สหกรณ์ออมทรัพย์พนักงานเครือเบทาโกร จำกัด กำหนดไว้ <br><br>
              <font color = "blue" size="2">ขั้นตอนการสมัครใช้บริการครั้งแรก</font><br>

                                        1.กรอกข้อมูล เลขทะเบียนสมาชิก, เลขที่บัตรประชาชน, วันเกิด, ชื่อ และนามสกุล <br>
                                        2.คลิก 'ข้าพเจ้ายอมรับเงิ่อนไขทั้งหมด' <br>
                                        3.ระบบจะ set password (ชั่วคราว) เริ่มต้นให้เป็นแบบสุ่ม และส่งให้ทราบทางอีเมล <br>
					</tr></table>
			</td>
          </tr>
          <tr>
            ...
            <form name="formID1" id="formID1" method="post" action="" >
              <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  ...
                  <td width="61%"><input name="member_no" type="text" class="validate[required,custom[integer]]" id="member_no" size="20" maxlength="10" autocomplete="off" style="width: 161px;"/></td>
                </tr>
                <tr>
                  <td align="right"><font face="Tahoma" size="2"><strong><strong>เลขที่บัตรประชาชน :</strong></strong></font></td>
                  <td><input name="idchk" type="text" class="validate[required,custom[integer],minSize[13]]" id="idchk" size="20" maxlength="13" autocomplete="off" style="width: 161px;"/></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="submit" name="Submit" id="button" value="ตกลง" />
                    ...
                    <!--<input name="agree" type="hidden" id="agree" value="agree" />--></td>
                </tr>
              </table>
            </form>
            </td>
                  ...
                  <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                      <td height="30" colspan="2" align="left" bgcolor="#666666"><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
                        <tr>
                          <td><strong><font size="2" face="Tahoma" color="#FFFFFF">กำหนดรหัสผู้ใช้อย่างน้อย 6 ตัวอักษร แต่ไม่เกิน 13 ตัวอักษร</font></strong></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td colspan="2" align="center"><table width="69%" border="0" cellspacing="2" cellpadding="2">
                        <tr>
                          ...
                          <td colspan="2"><input name="pwd_r" type="password" class="validate[required,minSize[6]]" id="pwd_r" size="35" maxlength="14" autocomplete="off"/></td>
                          </tr>
                        <tr>
                          <td align="right"><strong><font size="2" face="Tahoma">ยืนยันรหัสผ่าน :</font></strong></td>
                          <td colspan="2"><input name="pwd_r1" type="password" class="validate[required,equals[pwd_r]]" id="pwd_r1" size="35" maxlength="14" autocomplete="off"/></td>
                          </tr>
                        <tr>
                          <td align="right">&nbsp;</td>
                          <td width="4%">&nbsp;</td>
