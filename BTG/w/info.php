...
<body>
			...
			<?php
				if($_REQUEST["menu"] == "Member_info"){
					...
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Deposit_Show"){
					require "../lib/m.deposit1.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Loan"){
					require "../lib/m.loan.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Loan_Show"){
					require "../lib/m.loan1.php";
					//require "../d/closed.php";
					...
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Payment1_month"){
					require "../lib/m.payment1_month.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Payment"){
					require "../lib/m.payment.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Payment_month"){
					require "../lib/m.payment_month.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Dividend"){
					require "../lib/m.dividend.php";
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Benefits"){
					require "../lib/m.benefits.php";
					//require "../d/closed.php";
