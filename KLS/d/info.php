...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
          ...
          <tr>
			...
			<?php
				if($_REQUEST["menu"] == ""){
					...
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Payment_temp"){
					require "../lib/d.member_info.php";
					require "../lib/d.payment_temp.php";
					//require "../d/closed.php";
      ...
      <tr>
        <td height="80" colspan="2" align="center" background="../img/footer_info_bg.png"><br/><font size="2" color="#FFFFFF"><strong><?=$title?></strong></font><br/><font size="2" color="#FFFFFF"><?=$address?><br/><span class="class1"><?=$credite?></span></font></td>
      </tr>
    </table></td>
  </tr>
</table>
