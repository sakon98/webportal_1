...
if($_POST["button"] == "ค้นหา"){
	if(get_type($_POST["search"]) == "member"){
		...
		$strSQL = " SELECT id,date_reg,ipconnect,confirm_date,who_approve,password FROM mbmembmaster where member_no = $member_no ";
		$value = array('id','date_reg','ipconnect','confirm_date','who_approve','password');
