...
?>
 ...
 <input type="button" name="button" id="button" value="Print" class="addnews" onclick="myFunction()" style="width: 100px;margin-left: 230px;" /> 

<center><h2>ใบเเจ้งสถานะสภาพสมาชิก</h2></center>
<center><h2>สหกรณ์ออมทรัพย์ ปตท จำกัด</h2></center>

<table width="800px" border="0" align="center" cellpadding="1" cellspacing="6">
  <tr>
    <td width="100px" align="right"><font size="2">ทะเบียนสมาชิก :</font></td>
    <td width="100px" align="left" bgcolor="#D3D3D3"><font size="2"><?= $member_no?></font></td>
    <td width="100px" align="right"><font size="2">ชื่อ - สกุล :</font></td>
    <td width="150px" align="left" bgcolor="#D3D3D3"><font size="2"><?= $full_name?></font></td>
    <td width="100px" align="right"><font size="2">รหัสหน่วยงาน :</font></td>
    <td width="100px" align="left" bgcolor="#D3D3D3"><font size="2"><?= $membgroup_code?></font></td>
  </tr>
  <tr>
            ...
            <tr>
              ...
              <?php for($d=0;$d<$Num_Rows2;$d++){?>  
                <tr>
                  ...
                  <td width="10%" align="center" bgcolor="FFFFFF"><font size="2"><?=$deptaccount_no[$d]?></font></td>
                  <td width="10%" align="right" bgcolor="#FFFFFF"><font size="2"><?=$prncbal[$d]?></font></td>
                </tr>
                <?php } ?>
                <tr>
                  <td colspan="7" align="center" valign="middle"><hr size="1" color="#CCCCCC"></td>
...
<h4 style="margin-left: 200px;">ส่วนนี้สมาชิกเก็บไว้เป็นหลักฐาน</h4>
<p align="center">.......................................................................................................................................................................................................................</p>
        ...
        <td valign="top">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <?php for($b=0;$b<$Num_Rows1;$b++){?>  
                <tr>
                  <td width="27%" align="left" bgcolor="#FFFFFF"><font size="2"><?=$loantype[$b]?></font></td>
                  <td width="7%" align="center" bgcolor="#FFFFFF"><font size="2"><?=$loancontract_no[$b]?></font></td>
                  <td width="7%" align="center" bgcolor="#FFFFFF"><font size="2"><?=ConvertDate($statcont_date[$b],"short")?></font></td>
                  <td width="10%" align="right" bgcolor="#FFFFFF"><font size="2"><?=$loanapprove_amt[$b]?></font></td>
                  <td width="10%" align="right" bgcolor="#FFFFFF"><font size="2"><?=$principal_balance[$b]?></font></td>
                </tr>
                <?php } ?>
        ...
        <td valign="top">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <?php for($d=0;$d<$Num_Rows2;$d++){?>  
                <tr>
                  <td width="10%" align="left" bgcolor="#FFFFFF"><font size="2"><?=$depttype_desc[$d]?></font></td>
                  <td width="10%" align="center" bgcolor="#FFFFFF"><font size="2"><?=$deptaccount_no[$d]?></font></td>
                  <td width="10%" align="right" bgcolor="#FFFFFF"><font size="2"><?=$prncbal[$d]?></font></td>
                </tr>
                <?php } ?>
...
<h4 style="margin-left: 300px;">เรียน ผู้สอบบัญชีสหกรณ์ออมทรัพย์ ปตท จำกัด</h4>
<h4 style="margin-left: 350px;">( ) ถูกต้อง ( ) ไม่ถูกต้อง </h4> 
<h4 style="margin-left: 300px;"> ระบุ ................................................................................................................. </h4>
<h4 style="margin-left: 350px;"> ลงชื่อสมาชิก ......................................................................................... </h4>
<h4 style="margin-left: 300px;"> กรุณาตรวจสอบเเละส่งกลับมายังตู้รับใบเเจ้งสถานะภาพสมาชิก ณ ที่ทำการสหกรณ์ </h4>
