          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <?php 
					$strSQL = "SELECT 
										...
										DM.PRNCBAL AS PRNCBAL,
                                                                                (select D.prncbal from dpdeptstatement D where D.deptaccount_no = '$acc_no' 
                                                                                AND D.SEQ_NO = (SELECT MAX(D1.SEQ_NO) FROM dpdeptstatement D1 
                                                                                WHERE D1.deptaccount_no = D.deptaccount_no AND D1.OPERATE_DATE 
                                                                                BETWEEN TO_DATE('$date1', 'DD/MM/YYYY','NLS_CALENDAR=''THAI BUDDHA') 
                                                                                AND TO_DATE('$date2', 'DD/MM/YYYY','NLS_CALENDAR=''THAI BUDDHA') )) as A1
									FROM 
					...
					$value = array('DEP_DESC','DEPTACCOUNT_NAME','PRNCBAL','A1');
					...
					for($i=0;$i<$Num_Rows;$i++){
						...
						$prncbal_statement = $list_info[$i][$j++];
						$j=0;
					}
				?>
                <tr>
            ...
            <tr>
              <td height="30" align="center"><table width="95%" border="0" cellspacing="3" cellpadding="1">
                <tr>
                  <td height="23" align="center"><strong>(-<?=convertthai($prncbal_statement)?>-)</strong></td>
                  <td width="15%" align="right"><strong><?=number_format($prncbal_statement,2)?></strong></td>
                  <td width="16%" align="center">&nbsp;</td>
                </tr>
              </table></td>
            </tr>
