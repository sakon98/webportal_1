    ...
    <table width="995" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
      <tr>
        ...
        <table width="994" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="140" height="105" align="right"><img src="../img/logo.png" width="138" height="100"></td>
            <td width="845"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><font face='Tahoma' size="5" color="#000033"><strong>
                  <?=$title?>
                  </strong></font><br/>
                  <font face='Tahoma' size="2" color="#000033">
                    <?=$sub_title?>
                  </font></td>
              </tr>
              <tr>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="6">
          <tr>
            <td>
			<?php
				if($_REQUEST["menu"] == "" || $_REQUEST["menu"] == "Share"){
				     require "../lib/d.member_info.php";
					 require "../lib/d.share.php";
				}
				else if($_REQUEST["menu"] == "New"){
					...
					//require "../d/closed.php";
				}else if($_REQUEST["menu"] == "Year_month"){
					require "../lib/d.member_info.php";
					require "../lib/d.month_year.php";
					//require "../d/closed.php";
      ...
      <tr>
        <td height="80" colspan="2" align="center" background="../img/footer_info_bg.png"><font size="2" color="#000033"><strong><?=$title?></strong></font><br/><font size="2" color="#000033"><?=$address?><br/><span class="class1"><?=$credite?></span></font></td>
      </tr>
    </table></td>
  </tr>
</table>
