          ...
          <tr>
            <td align="center"><table width="75%" border="1" align="center" bordercolor = "red" cellpadding="20" cellspacing="0">
              ...
              **เงื่อนไขในการเปลี่ยนรหัสระบบข้อมูลสมาชิก**<br><br>
					...
					1. ทำการกรอกเลขทะเบียนสมาชิก <br>
					2. ทำการกรอกรหัสบัตรประชาชน <br>
					3. ทำการกรอกวันเกิดขอท่าน<br>
					4. เมื่อกรอกครบทุกช่องเเล้วเลือกตกลง <font color="red" size=3>ระบบจะ set password เริ่มต้นให้เป็น '1234'</font></font><br>
            ...
            <form name="formID1" id="formID1" method="post" action="" >
              <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  ...
                  <td><input name="idhbd" type="text" id="idhbd" size="20" maxlength="13" autocomplete="off" style="width: 161px;"/> <font color="#FF0000">** ตัวอย่างเช่น 22112523 (วันเดือนปี(พ.ศ))</font></td>
                </tr>
                <tr>
...
<?php
	...
	if($card_person	 != $idchk){ // เลขบัตรไม่ถูกต้อง
      ...
      // echo $birthday ;
       ...
       echo $day_c = substr($birthday, 0, 2);
       echo '<br>';
       echo $month_c = substr($birthday, 3, 2);
       echo '<br>';
       echo $year_c = substr($birthday, 6, 9);
       echo '<br>';
       echo $year_ps = $year_c + 543;
       echo '<br>';
       echo $bd_ps = $day_c.$month_c.$year_ps;
       echo '<br>';
       echo "$idhbd = ".$idhbd;
