...
if(isset($_REQUEST["MEMBER_NO"]))
{
 ...
 $ses_userid =session_id();
}

if(isset($_REQUEST["RECV_PERIOD"]))
{
 $_REQUEST["slip_date"]=$_REQUEST["RECV_PERIOD"];
}
            ...
            <tr>
              <td align="center" valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="1">
                ...
                <tr>
                  ...
                  <td><?=number_format($interest_accum[0],2)?></td>
                  </tr>
				   <tr>
                  <td><strong>หุ้นสะสม</strong>&nbsp;&nbsp;</td>
                  <td><?=number_format($sharestk_value[0],2) ?></td>
                  <td></td>
                  <td></td>
                  </tr>
              </table></td>
            ...
            <tr>
              ...
              <?php for($i=0;$i<$Num_Rows;$i++){?>  
				...
				<?php for($a=0;$a<$Num_Rows10;$a++){?>  
				 ...
				 <?php if($contno[$a] != "" && $memno[$a] != ""){ ?>
				 
			
				  <tr>
                <td colspan="4" align="center" valign="middle"> รับโอนจาก : ทะเบียน <?php echo $memno[$a]?> <?php echo $full_name?> เลขสัญญา <?php echo $contno[$a]?></strong></td>
                  <td align="right" valign="middle"><strong></strong></td>
                  <td width="13%" align="right" valign="middle"><strong></strong></td>
            ...
            <tr>
              <td align="center"><table width="95%" border="0" cellspacing="3" cellpadding="1">
                <tr>
				   ...
				   <td colspan="2" width="27%" height="50" align="center" valign="middle"><img src="../img/mg.png" width="125" height="47"></td>
				 ...
				 <tr>
				    ...
				    <td colspan="2" width="20%" align="center" valign="middle">นางสาวกัลยาณี เสมา</td>
				 ...
				 <tr>
				    ...
				    <td colspan="2" width="20%" align="center" valign="middle">ผู้จัดการ</td>
