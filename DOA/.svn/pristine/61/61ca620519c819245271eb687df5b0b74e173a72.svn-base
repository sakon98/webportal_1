...
$title = 'สหกรณ์ออมทรัพย์กรมวิชาการเกษตร จำกัด';
$title1 = 'สหกรณ์ออมทรัพย์กรมวิชาการเกษตร จำกัด';
$sub_title = 'ระบบบริการสมาชิก';
$sub_title1 = "DEPARTMENT OF AGRICULTURE SAVINGS AND CREDIT COOPERATIVE LTD.";
$address = '<font size="3">
50 ถนน พหลโยธิน แขวง ลาดยาว เขต จตุจักร กรุงเทพมหานคร 10900<br>
...
//$user_memu = array('ข้อมูลหุ้น','ข้อมูลเงินฝาก','ข้อมูลเงินกู้','ข้อมูลค้ำประกัน','รายการหักประจำเดือน');
//$user_link = array('Share','Deposit','Loan','Ref_collno','Payment');

$user_memu = array('ข้อมูลหุ้น','ข้อมูลเงินฝาก','ข้อมูลเงินกู้','ข้อมูลค้ำประกัน','รายการหักประจำเดือน','ปันผล-เฉลี่ยคืน');
$user_link = array('Share','Deposit','Loan','Ref_collno','Payment','Dividend');

//$user_memu = array('รายการหักประจำเดือน');
...
$admin_menu  = array('ข้อมูลสรุปรวม','อนุมัติ-ลบ สมาชิก','เปลี่ยนรหัสผ่าน');
