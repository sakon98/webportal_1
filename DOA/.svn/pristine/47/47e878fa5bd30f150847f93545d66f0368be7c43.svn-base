...
<table width="75%" border="0" align="center" cellpadding="1" cellspacing="4">
  ...
  <tr>
    ...
    <td align="center"><strong><?=$expense_amt?></strong></td>
  </tr>
  <tr>
    <td height="35" colspan="3" align="center" bgcolor="#CCCCFF"><font size="3" ><strong>ปันผล-เฉลี่ยคืนคงเหลือ : <font size="3" color="#FF6600"> <?=number_format($div_avg,2)?> </font> บาท</strong></font></td>
  </tr>
  <tr>
