                ...
                <tr>
                  <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                      ...
                      <input name="mobile1" type="text" class="validate[required,minSize[10]]" id="mobile1" size="35" value="<?=$phone?>" autocomplete="off"/>
					  <?php }else { ?> 
                      <input name="mobile1" type="text" class="validate[minSize[10]]" id="mobile1" size="35" value="<?=$phone?>" autocomplete="off"/>
                      <?php } ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" align="center"><table width="69%" border="0" cellspacing="2" cellpadding="2">
                        ...
                        <tr>
                          ...
                          <td colspan="2"><input name="pwd_r1" type="password" class="validate[required,equals[pwd_r],minSize[8]]" id="pwd_r1" size="35" maxlength="13" autocomplete="off"/></td>
                          </tr>
                        <tr>
                          <td align="right">&nbsp;</td>
                          <td width="4%">&nbsp;</td>
